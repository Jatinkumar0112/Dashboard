...
const Filters = () => {
  ...
  let {setCurrency,resetFunction} = useContext(CryptoContext)
  ...
  return (
    ...
    <div className='flex ' >
      ...
      <select name='sortby' className='rounded bg-gray-200 text-base pl-2 pr-10 py-1.5 leading-4 capitalized focus:outline-0' onClick={handleSort}>
      ...
      <img  src={selectIcon} alt='submit' className='w-[1rem] h-auto absolute right-0.5 top-2 pointer-events-none' />
      </label>
      <button className='w-[2rem] ml-4 hover:scale-110 transition-all transition-ease relative-row right-0 top-0' onClick={resetFunction}>
    <svg
    ...
    viewBox="0 0 24 24"
    className='w-full h-full fill-fuchsia'
