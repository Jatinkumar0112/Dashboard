...
const TableComponent = () => {
  ...
  return (
              ...
              return (
                ...
                >
                  ...
                  {/* <SaveBtn data={data} /> */}
                    ...
                    <span>
                      <Link to={`/${data.id}`} className='cursor-pointer'>{data.symbol}</Link>
                      </span>
                  </td>
    ...
    <div className="flex item-center justify-between mt-4 capitalize h-[2rem]">
      <span>Data provided by <a href="https://www.coingecko.com/" target={"black"} >Coingeko</a></span>
      <Pagination/>
    </div>
   </>
  );
